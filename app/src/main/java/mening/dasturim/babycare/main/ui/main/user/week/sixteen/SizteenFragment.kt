package mening.dasturim.babycare.main.ui.main.user.week.sixteen
...
class SizteenFragment : BasicFragment<FragmentSizteenBinding, OneFragmentVM>()  {
    ...
    override fun getLayoutResId()=R.layout.fragment_sizteen
